...
//            Main.Logger.Log("Weather notification displayed", ComplexLogger.FlaggedLoggingLevel.Debug);
//        }
...
//            Main.MonitorData.m_WeatherInformation ??= new();
...
//            else
//            {
//                Main.Logger.Log("New weather data added to database", ComplexLogger.FlaggedLoggingLevel.Debug);
...
//			JsonFile.Save<MainConfig>(Main.MonitorConfig, Main.Config);
//        }
//    }
//}
